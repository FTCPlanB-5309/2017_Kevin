...
@TeleOp(name = "Teleop Tank Drive", group = "Robot")
...
public class TeleopTank extends OpMode {
    ...
    public void loop() {
        ...
        robot.leftWheel.setPower(-gamepad1.left_stick_y);
        robot.rightWheel.setPower(-gamepad1.right_stick_y);
        if(gamepad1.dpad_left)
            robot.centerWheel.setPower(-0.5);
