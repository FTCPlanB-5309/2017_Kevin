...
public class MRI_Range_Linear extends LinearOpMode {
    ...
    I2cAddr RANGE2ADDRESS = new I2cAddr(0x2a); //Default I2C address for MR Range (7-bit)
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Ultra Sonic 2", range2Cache[0] & 0xFF);
            telemetry.addData("ODS 2", range2Cache[1] & 0xFF);
